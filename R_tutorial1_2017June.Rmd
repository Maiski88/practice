...
It makes sense to scale data because we are interested in changes over time

- Transpose & scale in one line each

```{r, echo = TRUE, out.width = "600px"}
...
```{r, echo = FALSE, message = FALSE, out.width = "700px"}
